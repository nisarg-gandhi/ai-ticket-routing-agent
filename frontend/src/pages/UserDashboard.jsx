    ...
    <div className="space-y-8 pb-10">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-indigo-600 to-violet-600 text-white rounded-xl hover:from-indigo-500 hover:to-violet-500 hover:shadow-md shadow-md shadow-indigo-500/20 active:scale-95 transition-all duration-200 text-sm font-semibold"
        >
