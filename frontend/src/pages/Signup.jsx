...
const Register = () => {
  ...
  return (
    <div className="auth-page min-h-screen flex items-center justify-center px-4 py-12 font-sans antialiased"
      ...
      <div className="w-full max-w-md">
        <div className="bg-white border border-[#E8E2DA] shadow-sm rounded-2xl px-8 py-10 sm:px-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Full name */}
            <div>
              <label htmlFor="register-name" className="block text-xs font-medium text-[#6B6560] mb-1.5 uppercase tracking-wider">
                Full name
              </label>
            ...
            {/* Email */}
            <div>
              <label htmlFor="register-email" className="block text-xs font-medium text-[#6B6560] mb-1.5 uppercase tracking-wider">
                Email address
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            ...
            {/* Password */}
            <div>
              <label htmlFor="register-password" className="block text-xs font-medium text-[#6B6560] mb-1.5 uppercase tracking-wider">
                Password
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
